...
| **Image Engine** | "Gemini" | Always specify the **"latest Gemini model"** for final image generation |
...
#### A. Specify the Generation Engine
Always include the model for final image rendering:
- Use **"Gemini latest model"** or simply **"usa gemini"** for all photograph/rendering generation.
- Place this instruction as a core requirement for high-fidelity images.

#### B. Add UI/UX Keywords
...
- Image Engine: **Gemini (Latest Model)**
